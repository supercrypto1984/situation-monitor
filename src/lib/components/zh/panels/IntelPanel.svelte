<script lang="ts">
	...
	function getTranslatedSourceType(sourceType: SourceType): string {
		switch (sourceType) {
			case 'osint': return '开源情报';
			case 'govt': return '政府';
			case 'think-tank': return '智库';
			case 'defense': return '防务';
			case 'regional': return '区域';
			case 'cyber': return '网络';
				...
				<div class="intel-item" class:priority={item.isPriority}>
					<div class="intel-header">
						...
						<div class="intel-tags">
							<Badge
								text={getTranslatedSourceType(item.sourceType).toUpperCase()}
